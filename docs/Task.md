...
![image](https://github.com/DmitryGudov/diploma/assets/124876096/bf5bb08d-86ab-45fd-929c-98f365deb7b4)
...
Само приложение расположено в файле [`aqa-shop.jar`](aqa-shop.jar) и запускается стандартным
способом `java -jar aqa-shop.jar` на порту 8080.
